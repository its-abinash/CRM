 ...
 */
exports.format = function (message, formatList) {
...
exports.validatePayload = async function (payload, schema) {
...
exports.processPayload = async function(payload) {
  var result = {}
...
exports.cloneObject = function(dataObject) {
