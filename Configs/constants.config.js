...
module.exports = {
  ...
  ResponseIds: {
    ...
    RI_011: "Successfully inserted {0} of userId: {1}",
    RI_012: "Failed to insert {0} of userId: {1}",
    RI_013: "Successfully sent email to userId: {0}",
    RI_014: "Failed to send email to userId: {0}",
